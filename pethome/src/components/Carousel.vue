    ...
    <div id="banner"  :style="{width:innerWidth+'px'}" @mouseenter="stop" @mouseleave="start">
        ...
        <ul id="ul-imgs"  :class="ulClass" :style="ulStyle">
            <li v-for="(img,i) of imgs" :key="i"  :style="{width:innerWidth+'px'}">
                <router-link :to="webs[i]" :title="img.title">
                    <img :src="`http://127.0.0.1:5050/${img.pic}`" :style="{width:innerWidth+'px'}" alt="">
                </router-link>
            </li>
            <li  :style="{width:innerWidth+'px'}">
                <router-link :to="webs[i]" :title="imgs[0].title">
                    <img :src="`http://127.0.0.1:5050/${imgs[0].pic}`" :style="{width:innerWidth+'px'}" alt="">
                </router-link>
            </li>
        </ul>
        <!-- 3、轮播指示器 -->
...
export default {
    data(){
        return {
            ...
            webs:['index','cutepets','products','aboutpet','aboutus'],
